...
urlpatterns = [
    ...
    path('admin/gemeldete-produkte/', views.support_produkt_list, name='cs_produkt_list'),
    path('produkt/<int:pk>/melden/', views.produkt_report, name='produkt_report'),
    path('admin/gemeldete-produkte/<int:pk>/unreport/', views.support_produkt_unreport, name='cs_produkt_unreport'),
    path('admin/gemeldete-produkte/<int:pk>/delete/', views.support_produkt_delete, name='cs_produkt_delete'),
]